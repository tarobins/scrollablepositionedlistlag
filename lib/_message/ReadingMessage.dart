                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        TextField(
                            ...
                            style: TextStyle(
                                color:
                                    _isThemeDark ? Colors.white : Colors.black,
                                fontSize: 18),
                            decoration: InputDecoration(
                              filled: true,
                              fillColor:
                                  _isThemeDark ? Colors.black : Colors.white,
                        ...
                        StreamBuilder<String>(
                            ...
                            builder: (context,
                                snapshotOutValueJumpParagraphMsgError) {
                              if (snapshotOutValueJumpParagraphMsgError.data ==
                                  null) {
                                return Container();
                              }
                              return Padding(
                                ...
                                child: Text(
                                    "${snapshotOutValueJumpParagraphMsgError.data}",
                  ...
                  new FlatButton(
                    ...
                    onPressed: () {
                      if (_textEditingController.text == "") {
                        ...
                        _bloc.setJumpParagraphMsgError(
                            "O número dever ser maior que 1");
      ...
      body: FutureBuilder<Message>(
          ...
          builder: (context, snapshotGetMessages) {
            if (snapshotGetMessages.hasError) {
              return Center(
                  child: Text(snapshotGetMessages.error.toString(),
                      style: TextStyle(
                      ...
                      itemBuilder: (context, index) {
                        if (snapshotGetMessages.data.paragraphs.length > 0) {
                          if (index == 0) {
                            return Container(
                              ...
                              child: Center(
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: <Widget>[
                                    Text('${snapshotGetMessages.data.title}',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold),
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis),
                                    Text('${snapshotGetMessages.data.place}',
                                        textAlign: TextAlign.center),
                                    Text('${snapshotGetMessages.data.date}',
                                        textAlign: TextAlign.center),
                                    Text(
                                        "Tradução: ${snapshotGetMessages.data.translation}",
                                        textAlign: TextAlign.center),
                                  ],
                                ),
                              ),
                            ...
                            index = index - 1;
                            String numberParagraph = snapshotGetMessages
                                .data.paragraphs[index].number
                                .toString();
                            String textParagraph = snapshotGetMessages
                                .data.paragraphs[index].text
                                .toString();
                            String textPrgNoNumAndTab = textParagraph
